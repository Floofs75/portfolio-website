...
function About() {
    return(
        ...
        <section className='aboutSection' id='about'>
            ...
            <h1 className='aboutHeading'>So what makes up...<br/> <strong>Well, me?</strong></h1>
            
            <div className='aboutCon'>

                <div className='aboutContent'>
                    <h2>A born and raised South African</h2>
                    <p>I am the youngest in my family, and naturally the most ambitious. I 
                        have a focus on improving any field I involve myself within.
                    </p>
                </div>

                <div className='aboutContent'>
                    <h2>A competitor offline and online</h2>
                    <p>From competing in Valorant as an In-Game Leader for SIN E-sports,
                ...
                <div className='aboutContent'>
                    ...
                    <p>Video games, all kinds of music, arts and crafts, science...I have 
